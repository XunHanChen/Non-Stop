Shader "Ciconia Studio/CS_Wet Animation/URP/Flood/Opaque"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						, FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_Target
			{
				...
				float2 break26_g547 = uv_BaseMap;
				float GlobalTilingX11 = ( _GlobalXYTilingXYZWOffsetXY.x - 1.0 );
				float GlobalTilingY8 = ( _GlobalXYTilingXYZWOffsetXY.y - 1.0 );
				float2 appendResult14_g547 = (float2(( break26_g547.x * GlobalTilingX11 ) , ( break26_g547.y * GlobalTilingY8 )));
				float GlobalOffsetX10 = _GlobalXYTilingXYZWOffsetXY.z;
				float GlobalOffsetY9 = _GlobalXYTilingXYZWOffsetXY.w;
				float2 appendResult13_g547 = (float2(( break26_g547.x + GlobalOffsetX10 ) , ( break26_g547.y + GlobalOffsetY9 )));
				float2 uv_ParallaxMap = IN.ase_texcoord7.xyz.xy * _ParallaxMap_ST.xy + _ParallaxMap_ST.zw;
				float2 break26_g465 = uv_ParallaxMap;
				float2 appendResult14_g465 = (float2(( break26_g465.x * GlobalTilingX11 ) , ( break26_g465.y * GlobalTilingY8 )));
				float2 appendResult13_g465 = (float2(( break26_g465.x + GlobalOffsetX10 ) , ( break26_g465.y + GlobalOffsetY9 )));
				float4 temp_cast_0 = (tex2D( _ParallaxMap, ( appendResult14_g465 + appendResult13_g465 ) ).g).xxxx;
				float3 tanToWorld0 = float3( WorldTangent.x, WorldBiTangent.x, WorldNormal.x );
				float3 tanToWorld1 = float3( WorldTangent.y, WorldBiTangent.y, WorldNormal.y );
				float3 tanToWorld2 = float3( WorldTangent.z, WorldBiTangent.z, WorldNormal.z );
				float3 ase_tanViewDir =  tanToWorld0 * WorldViewDirection.x + tanToWorld1 * WorldViewDirection.y  + tanToWorld2 * WorldViewDirection.z;
				ase_tanViewDir = normalize(ase_tanViewDir);
				float2 paralaxOffset36_g464 = ParallaxOffset( temp_cast_0.x , _Parallax , ase_tanViewDir );
				float2 switchResult47_g464 = (((ase_vface>0)?(paralaxOffset36_g464):(0.0)));
				float2 Parallaxe494 = switchResult47_g464;
				float4 tex2DNode7_g546 = tex2D( _BaseMap, ( ( appendResult14_g547 + appendResult13_g547 ) + Parallaxe494 ) );
				float clampResult27_g546 = clamp( _Saturation , -1.0 , 100.0 );
				float3 desaturateInitialColor29_g546 = ( _Color * tex2DNode7_g546 ).rgb;
				float desaturateDot29_g546 = dot( desaturateInitialColor29_g546, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar29_g546 = lerp( desaturateInitialColor29_g546, desaturateDot29_g546.xxx, -clampResult27_g546 );
				float4 temp_output_527_0 = CalculateContrast(_Brightness,float4( desaturateVar29_g546 , 0.0 ));
				float2 uv_DetailAlbedoMap = IN.ase_texcoord7.xyz.xy * _DetailAlbedoMap_ST.xy + _DetailAlbedoMap_ST.zw;
				float4 tex2DNode7_g611 = tex2D( _DetailAlbedoMap, ( uv_DetailAlbedoMap + ( float2( 0,0 ) * float2( 0,0 ) ) ) );
				float4 BaseColorRGB403 = temp_output_527_0;
				#ifdef _USEMAINALBEDOMAP_ON
				float4 staticSwitch38_g611 = BaseColorRGB403;
				#else
				float4 staticSwitch38_g611 = tex2DNode7_g611;
				#endif
				float clampResult27_g611 = clamp( _DetailSaturation , -1.0 , 100.0 );
				float3 desaturateInitialColor29_g611 = ( _DetailColor * staticSwitch38_g611 ).rgb;
				float desaturateDot29_g611 = dot( desaturateInitialColor29_g611, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar29_g611 = lerp( desaturateInitialColor29_g611, desaturateDot29_g611.xxx, -clampResult27_g611 );
				float4 AlbedoDetail153 = CalculateContrast(_DetailBrightness,float4( desaturateVar29_g611 , 0.0 ));
				float2 uv_DetailMask = IN.ase_texcoord7.xyz.xy * _DetailMask_ST.xy + _DetailMask_ST.zw;
				float4 tex2DNode27_g610 = tex2D( _DetailMask, uv_DetailMask );
				#if defined(_CHANNELSELECTIONMASK_RED)
				float staticSwitch28_g610 = tex2DNode27_g610.r;
				#elif defined(_CHANNELSELECTIONMASK_GREEN)
				float staticSwitch28_g610 = tex2DNode27_g610.g;
				#elif defined(_CHANNELSELECTIONMASK_BLUE)
				float staticSwitch28_g610 = tex2DNode27_g610.b;
				#elif defined(_CHANNELSELECTIONMASK_ALPHA)
				float staticSwitch28_g610 = tex2DNode27_g610.a;
				#else
				float staticSwitch28_g610 = tex2DNode27_g610.r;
				#endif
				float BaseColorAlpha46 = (( _InvertABaseColor )?( ( 1.0 - tex2DNode7_g546.a ) ):( tex2DNode7_g546.a ));
				float temp_output_43_0_g610 = BaseColorAlpha46;
				#if defined(_SOURCEMASK_DETAILMASK)
				float staticSwitch45_g610 = (( _InvertMask )?( ( 1.0 - staticSwitch28_g610 ) ):( staticSwitch28_g610 ));
				#elif defined(_SOURCEMASK_BASECOLORALPHA)
				float staticSwitch45_g610 = temp_output_43_0_g610;
				#elif defined(_SOURCEMASK_BOTH)
				float staticSwitch45_g610 = ( (( _InvertMask )?( ( 1.0 - staticSwitch28_g610 ) ):( staticSwitch28_g610 )) + temp_output_43_0_g610 );
				#else
				float staticSwitch45_g610 = (( _InvertMask )?( ( 1.0 - staticSwitch28_g610 ) ):( staticSwitch28_g610 ));
				#endif
				float4 temp_cast_8 = (( staticSwitch45_g610 + (-1.2 + (_SpreadDetailMap - 0.0) * (0.7 - -1.2) / (1.0 - 0.0)) )).xxxx;
				float4 temp_output_35_0_g610 = CalculateContrast(( _ContrastDetailMap + 1.0 ),temp_cast_8);
				float4 clampResult38_g610 = clamp( (( _ExcludeMask )?( ( temp_output_35_0_g610 * ( 1.0 - temp_output_43_0_g610 ) ) ):( temp_output_35_0_g610 )) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				float4 Mask158 = ( clampResult38_g610 * _IntensityMask );
				...
				float3 unpack4_g634 = UnpackNormalScale( tex2D( _BumpMap, ( ( appendResult14_g635 + appendResult13_g635 ) + Parallaxe494 ) ), _BumpScale );
				unpack4_g634.z = lerp( 1, unpack4_g634.z, saturate(_BumpScale) );
				float3 temp_output_495_0 = unpack4_g634;
				...
				float cos54_g636 = cos( radians( _RotationAngle1 ) );
				float sin54_g636 = sin( radians( _RotationAngle1 ) );
				float2 rotator54_g636 = mul( ( uv_DetailNormalMap * _TilingWave1 ) - float2( 0.5,0.5 ) , float2x2( cos54_g636 , -sin54_g636 , sin54_g636 , cos54_g636 )) + float2( 0.5,0.5 );
				float2 panner86_g636 = ( ( _TimeParameters.x * 0.05 ) * temp_cast_10 + rotator54_g636);
				float3 unpack107_g636 = UnpackNormalScale( tex2D( _DetailNormalMap, panner86_g636 ), _NormalWaveIntensity1 );
				unpack107_g636.z = lerp( 1, unpack107_g636.z, saturate(_NormalWaveIntensity1) );
				#ifdef _MAINWAVE_ON
				float3 staticSwitch109_g636 = unpack107_g636;
				#else
				float3 staticSwitch109_g636 = float3(0,0,1);
				#endif
				float2 temp_cast_11 = (_TranslationSpeed2).xx;
				float cos83_g636 = cos( radians( _RotationAngle2 ) );
				float sin83_g636 = sin( radians( _RotationAngle2 ) );
				float2 rotator83_g636 = mul( ( uv_DetailNormalMap * _TilingWave2 ) - float2( 0.5,0.5 ) , float2x2( cos83_g636 , -sin83_g636 , sin83_g636 , cos83_g636 )) + float2( 0.5,0.5 );
				float2 panner88_g636 = ( ( _TimeParameters.x * 0.05 ) * temp_cast_11 + rotator83_g636);
				float3 unpack108_g636 = UnpackNormalScale( tex2D( _DetailNormalMap, panner88_g636 ), _NormalWaveIntensity2 );
				unpack108_g636.z = lerp( 1, unpack108_g636.z, saturate(_NormalWaveIntensity2) );
				#ifdef _DETAILWAVE_ON
				float3 staticSwitch56_g636 = BlendNormal( staticSwitch109_g636 , unpack108_g636 );
				#else
				float3 staticSwitch56_g636 = staticSwitch109_g636;
				#endif
				float3 NormalPuddles459 = staticSwitch56_g636;
				float3 lerpResult137 = lerp( temp_output_495_0 , NormalPuddles459 , Mask158.rgb);
				float3 lerpResult205 = lerp( temp_output_495_0 , BlendNormal( temp_output_495_0 , NormalPuddles459 ) , Mask158.rgb);
				...
				float2 break26_g641 = uv_EmissionMap;
				...
				float4 temp_output_503_0 = ( _EmissionColor * tex2D( _EmissionMap, ( ( appendResult14_g641 + appendResult13_g641 ) + Parallaxe494 ) ) * _EmissionIntensity );
				float4 temp_cast_14 = (0.0).xxxx;
				float4 lerpResult394 = lerp( temp_output_503_0 , temp_cast_14 , Mask158);
				float3 worldRefl28_g637 = normalize( reflect( -WorldViewDirection, float3( dot( tanToWorld0, (( _UseMainNormalMapasNormalDirection )?( Normal27 ):( NormalPuddles459 )) ), dot( tanToWorld1, (( _UseMainNormalMapasNormalDirection )?( Normal27 ):( NormalPuddles459 )) ), dot( tanToWorld2, (( _UseMainNormalMapasNormalDirection )?( Normal27 ):( NormalPuddles459 )) ) ) ) );
				float4 texCUBENode27_g637 = texCUBElod( _Cubemap, float4( worldRefl28_g637, _BlurReflection) );
				float clampResult39_g637 = clamp( _ReflectionIntensity , 0.0 , 100.0 );
				float4 Emission110 = ( (( _UseEmissionFromMainProperties )?( temp_output_503_0 ):( lerpResult394 )) + ( ( texCUBENode27_g637 * ( texCUBENode27_g637.a * clampResult39_g637 ) * _ColorCubemap1 ) * Mask158 ) );
				
				float2 uv_MetallicGlossMap = IN.ase_texcoord7.xyz.xy * _MetallicGlossMap_ST.xy + _MetallicGlossMap_ST.zw;
				float2 break26_g639 = uv_MetallicGlossMap;
				...
				float4 tex2DNode3_g638 = tex2D( _MetallicGlossMap, ( ( appendResult14_g639 + appendResult13_g639 ) + Parallaxe494 ) );
				float DetailMetallic381 = _Metallic2;
				float lerpResult382 = lerp( ( tex2DNode3_g638.r * _Metallic ) , DetailMetallic381 , Mask158.r);
				float Metallic41 = lerpResult382;
				
				#if defined(_SOURCE_METALLICALPHA)
				float staticSwitch23_g638 = ( tex2DNode3_g638.a * _Glossiness );
				#elif defined(_SOURCE_BASECOLORALPHA)
				float staticSwitch23_g638 = ( _Glossiness * BaseColorAlpha46 );
				#else
				float staticSwitch23_g638 = ( tex2DNode3_g638.a * _Glossiness );
				#endif
				float DetailSmoothness374 = _Glossiness2;
				float lerpResult377 = lerp( staticSwitch23_g638 , DetailSmoothness374 , Mask158.r);
				float Smoothness40 = lerpResult377;
				
				float2 uv_OcclusionMap = IN.ase_texcoord7.xyz.xy * _OcclusionMap_ST.xy + _OcclusionMap_ST.zw;
				float2 break26_g643 = uv_OcclusionMap;
				float2 appendResult14_g643 = (float2(( break26_g643.x * GlobalTilingX11 ) , ( break26_g643.y * GlobalTilingY8 )));
				float2 appendResult13_g643 = (float2(( break26_g643.x + GlobalOffsetX10 ) , ( break26_g643.y + GlobalOffsetY9 )));
				float blendOpSrc2_g642 = tex2D( _OcclusionMap, ( ( appendResult14_g643 + appendResult13_g643 ) + Parallaxe494 ) ).r;
				float blendOpDest2_g642 = ( 1.0 - _OcclusionStrength );
				float temp_output_502_0 = ( saturate( ( 1.0 - ( 1.0 - blendOpSrc2_g642 ) * ( 1.0 - blendOpDest2_g642 ) ) ));
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN , FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_TARGET
			{
				...
				float4 lerpResult394 = lerp( temp_output_503_0 , temp_cast_10 , Mask158);
				...
				float sin54_g636 = sin( radians( _RotationAngle1 ) );
				float2 rotator54_g636 = mul( ( uv_DetailNormalMap * _TilingWave1 ) - float2( 0.5,0.5 ) , float2x2( cos54_g636 , -sin54_g636 , sin54_g636 , cos54_g636 )) + float2( 0.5,0.5 );
				float2 panner86_g636 = ( ( _TimeParameters.x * 0.05 ) * temp_cast_11 + rotator54_g636);
				float3 unpack107_g636 = UnpackNormalScale( tex2D( _DetailNormalMap, panner86_g636 ), _NormalWaveIntensity1 );
				unpack107_g636.z = lerp( 1, unpack107_g636.z, saturate(_NormalWaveIntensity1) );
				#ifdef _MAINWAVE_ON
				float3 staticSwitch109_g636 = unpack107_g636;
				...
				float sin83_g636 = sin( radians( _RotationAngle2 ) );
				float2 rotator83_g636 = mul( ( uv_DetailNormalMap * _TilingWave2 ) - float2( 0.5,0.5 ) , float2x2( cos83_g636 , -sin83_g636 , sin83_g636 , cos83_g636 )) + float2( 0.5,0.5 );
				float2 panner88_g636 = ( ( _TimeParameters.x * 0.05 ) * temp_cast_12 + rotator83_g636);
				float3 unpack108_g636 = UnpackNormalScale( tex2D( _DetailNormalMap, panner88_g636 ), _NormalWaveIntensity2 );
				unpack108_g636.z = lerp( 1, unpack108_g636.z, saturate(_NormalWaveIntensity2) );
				#ifdef _DETAILWAVE_ON
				float3 staticSwitch56_g636 = BlendNormal( staticSwitch109_g636 , unpack108_g636 );
				...
				float3 lerpResult205 = lerp( temp_output_495_0 , BlendNormal( temp_output_495_0 , NormalPuddles459 ) , Mask158.rgb);
				float3 Normal27 = (( _BlendMainNormal )?( lerpResult205 ):( lerpResult137 ));
				float3 worldRefl28_g637 = normalize( reflect( -ase_worldViewDir, float3( dot( tanToWorld0, (( _UseMainNormalMapasNormalDirection )?( Normal27 ):( NormalPuddles459 )) ), dot( tanToWorld1, (( _UseMainNormalMapasNormalDirection )?( Normal27 ):( NormalPuddles459 )) ), dot( tanToWorld2, (( _UseMainNormalMapasNormalDirection )?( Normal27 ):( NormalPuddles459 )) ) ) ) );
				float4 texCUBENode27_g637 = texCUBElod( _Cubemap, float4( worldRefl28_g637, _BlurReflection) );
				float clampResult39_g637 = clamp( _ReflectionIntensity , 0.0 , 100.0 );
				float4 Emission110 = ( (( _UseEmissionFromMainProperties )?( temp_output_503_0 ):( lerpResult394 )) + ( ( texCUBENode27_g637 * ( texCUBENode27_g637.a * clampResult39_g637 ) * _ColorCubemap1 ) * Mask158 ) );
